							...
							<div class="card">
								<div class="card-main">
									<div class="card-inner margin-bottom-no">
										...
										<p><i class="icon icon-lg">desktop_windows</i>&nbsp;<a href="/downloads/shadowsocksr.zip">Windows</a></p>
										<p><i class="icon icon-lg">laptop_mac</i>&nbsp;<a href="/downloads/ssr-osx.zip">Mac OS X</a></p>
										<!-- <p><i class="icon icon-lg">laptop_windows</i>&nbsp;<a href="https://github.com/breakwa11/shadowsocks-rss/wiki/Python-client">Linux</a></p> -->
										<p><i class="icon icon-lg">android</i>&nbsp;<a href="/downloads/shadowsocksr-release.apk">Android</a></p>
										<p><i class="icon icon-lg">phone_iphone</i>&nbsp;<a href="https://itunes.apple.com/cn/app/shadowrocket/id932747118?mt=8">iOS</a></p>
									</div>
