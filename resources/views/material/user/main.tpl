				...
				<ul class="nav">
					<li>
						...
						<ul class="menu-collapse collapse in" id="ui_menu_me">
							...
							{if $user->isAdmin()}
							<li>
								<a href="/user/inviteurl">
									<i class="icon icon-lg">plus_one</i>&nbsp;邀请好友
								</a>
							</li>
							{/if}
						...
						<ul class="menu-collapse collapse in" id="ui_menu_use">
							...
							<li>
								<a href="/user/navigation?tag=1">
									<i class="icon icon-lg">favorite</i>&nbsp;站点导航
								</a>
							</li>
						...
						<ul class="menu-collapse collapse in" id="ui_menu_help">
							...
							<li>
								<a href="/user/save">
									<i class="icon icon-lg">card_giftcard</i>&nbsp;优惠码
								</a>
							</li>
							...
							<li>
								<a href="//shang.qq.com/wpa/qunwpa?idkey=10381c3b75c41733e11bd9b5eba020d2f8397499b50c09a61f7ce3af86b681bf">
									<i class="icon icon-lg">build</i>&nbsp;售后/咨询
								</a>
							</li>
