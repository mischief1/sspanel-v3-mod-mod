						...
						<div class="card margin-bottom-no">
							<div class="card-main">
								<div class="card-inner">
									<div class="card-inner">
										<p class="card-heading">支付宝充值，如果提示不可用使用下面的充值码方式充值</p>
					...
					<div class="col-lg-12 col-md-12">
						<div class="card margin-bottom-no">
							<div class="card-main">
								<div class="card-inner">
									<div class="card-inner">
										<p class="card-heading">充值码，购买充值码后将充值码复制回来填入下面的输入框中点充值即可</p>
										<p>当前余额：{$user->money} 元，<a href="http://www.yunfaka.com/links/7282AC371E74CBE5">点此购买充值码</a></p>
										<div class="form-group form-group-label">
